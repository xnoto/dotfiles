...
install:
	...
	@echo "Adding GitHub MCP Token to .bashrc.d and .zprofile"
	@echo "export GITHUB_TOKEN=${GITHUB_MCP_TOKEN}" >>$(HOME)/.bashrc.d/github
	@echo "export GITHUB_TOKEN=${GITHUB_MCP_TOKEN}" >>$(HOME)/.zprofile
	@echo "Adding Grafana MCP Token to .bashrc.d and .zprofile"
	@echo "export GRAFANA_TOKEN=${GRAFANA_MCP_TOKEN}" >>$(HOME)/.bashrc.d/grafana
